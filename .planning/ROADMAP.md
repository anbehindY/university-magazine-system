...
- [x] **v1.1 Security, Audit & Guest Self-Registration** -- Phases 10-14 (shipped 2026-03-09)
...
**Plans:** 1/1 plans complete
Plans:
- [x] 14-01-PLAN.md -- Analytics API endpoint, Recharts dashboard page, sidebar entry (2 tasks)
